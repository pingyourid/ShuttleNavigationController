//
//  HJVCCardsAnimation.m
//  CommonLib
//
//  Created by bibibi on 15/7/29.
//  Copyright (c) 2015年 ihome. All rights reserved.
//

#import "HJVCCardsAnimation.h"

@implementation HJVCCardsAnimation
...
- (void)executeForwardsAnimation:(id<UIViewControllerContextTransitioning>)transitionContext fromVC:(UIViewController *)fromVC toVC:(UIViewController *)toVC fromView:(UIView *)fromView toView:(UIView *)toView
{
    ...
    [UIView animateKeyframesWithDuration:self.duration
        ...
        animations:^{
          ...
          [UIView addKeyframeWithRelativeStartTime:0.2f
                                  relativeDuration:0.4f
                                        animations:^{
          ...
          [UIView addKeyframeWithRelativeStartTime:0.6f
                                  relativeDuration:0.2f
                                        animations:^{
                                          toView.frame = CGRectOffset(toView.frame, 0.0, -30.0);
                                        }];
          [UIView addKeyframeWithRelativeStartTime:0.8f
                                  relativeDuration:0.2f
                                        animations:^{
                                          toView.frame = frame;
                                        }];
...
- (void)executeReverseAnimation:(id<UIViewControllerContextTransitioning>)transitionContext fromVC:(UIViewController *)fromVC toVC:(UIViewController *)toVC fromView:(UIView *)fromView toView:(UIView *)toView
{
    ...
    [UIView animateKeyframesWithDuration:self.duration
        ...
        animations:^{
          ...
          [UIView addKeyframeWithRelativeStartTime:0.35f
                                  relativeDuration:0.35f
                                        animations:^{
